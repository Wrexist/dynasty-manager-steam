...
export const PENDING_NEWS: PendingRelease = {
  ...
  improved: [
    ...
    'Desktop navigation is now a left sidebar with nested sub-tabs for clearer hierarchy.',
    'Keyboard shortcuts: Escape to go back, letter keys for quick nav, ? for help.',
    'New keyboard shortcuts overlay (press ? to view all bindings).',
    'Sidebar footer with quick-nav buttons and a discoverable shortcuts entry point.',
  ],
  fixed: [],
  headline: null,
  summary: null,
